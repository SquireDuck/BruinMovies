  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black to-blue-900 text-white">
      ...
      <div className="flex flex-col items-center justify-center px-4 md:px-0 py-8">
        <div className="bg-gradient-to-b from-gray-800 via-gray-800 to-gray-900 p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            {isRegister && (
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
